          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className={Css.input}>
              <div className={Css.inputs}>
                <input type="text" id="username" placeholder="UserName" name="username" onChange={handleChange} required/>
              ...
              <div className={Css.text}>
                {ChangeValue.username[0] ===
                  ...
                  Accpet && (
                    <p className={Css.errors}>  You must write a capital letter at the beginning of your  name</p>)}
              </div>
            </div>
            {/* Here for 2nd Input Email */}
            <div className={Css.input}>
              <div className={Css.inputs}>
                <input  type="email"  id="mail"  placeholder="Email"  name="email"  onChange={handleChange}  required/>
                <label htmlFor="mail">
                  <IoMdMail />
                </label>
              </div>
            ...
            <div className={Css.input}>
              <div className={Css.inputs}>
                <input  type="password"  id="password"  placeholder="Password"  name="passowrd"  onChange={handleChange}/>
              ...
              <div className={Css.text}>
                {ChangeValue.passowrd.length < 8 && Accpet && (
                  <p className={Css.errors}>  It must contain in the last number a capital and lowercase  letter</p>
                )}
              </div>
            </div>
            ...
            <div className={Css.input}>
              <div className={Css.inputs}>
                <input type="password"  id="RePassword"  placeholder="Reapet Password"  name="passowrdReapet"  onChange={handleChange}  required/>
